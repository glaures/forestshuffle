export default {
    ...
    it: {
        cookies: {
            intro: "Questo sito web utilizza i cookie - maggiori informazioni su questo e sui tuoi diritti come utente sono disponibili nella nostra Informativa sulla privacy. Fai clic su \"Accetta tutto\" per accettare i cookie e utilizzare direttamente il nostro sito web, oppure gestisci i tuoi cookie facendo clic qui",
            settings: "Impostazioni dei cookie",
            acceptAll: "Accetta tutto",
            acceptSelection: "Conferma selezione",
            technical: "Per la memorizzazione dei dati essenziali per il funzionamento del sito web",
            tracking: "Per memorizzare i dati necessari per l'analisi anonima del comportamento degli utenti",
            social: "Consentire i social media sul sito web",
            consentRequired: "Per favore, acconsenti prima ai cookie"
        },
// general strings
        forrestShuffle: "Foresta mista",
        scoringApp: "App di punteggio",
        imprint: "Impressum",
        dataProtection: "Protezione dei dati",
        letsGo: "Andiamo",
        points: 'Punti',
        player: 'Giocatore',
        treeTypeCount: 'Numero di simboli dei tipi di alberi',
        startNewGame: 'Inizia un nuovo gioco',
        resetPlayers: 'Reimposta giocatori',
        alpineExpansion: 'Espansione alpina',
// error messages
        "error.nameTaken": "Il nome {0} è già stato preso.",
// symbols
        trees: "Alberi",
        tops: "In alto",
        bottoms: "In basso",
        ...
        amphibians: "Anfibi",
        insects: "Insetti",
        pawedAnimals: "Animali con zampa",
        bats: "Pipistrelli",
        deer: "Cervo",
        clovenHoofedAnimal: "Animale con zoccoli divisi",
        alps: "Alpi",
        silverFirCount: "Simboli dell'abete bianco",
        lindenCount  : "Simboli del tiglio",
        horseChestnutCount  : "Simboli dell'ippocastano",
        birchCount  : "Simboli della betulla",
        beechCount  : "Simboli del faggio",
        sycamoreCount  : "Simboli dell'acero",
        douglasFirCount  : "Simboli dell'abete di Douglas",
        oakCount  : "Simboli della quercia",
        europeanLarchCount  : "Simboli del larice europeo",
        stonePineCount : "Simboli del pino cembro",
// cards
        beech: "Faggio",
        birch: "Betulla",
        ...
        cardsAttachedToSilverFirs: "Carte attaccate agli abeti bianchi",
        sycamore: "Acero",
        treeSaplings: "Germoglio",
        bullfinch: "Ciuffolotto",
        chaffinch: "Fringuello",
        chaffinchesAtopABeech: "su un faggio",
        eurasianJay: "Ghiandaia",
        goshawk: "Astore",
        greatSpottedWoodpecker: "Picchio rosso maggiore",
        tawnyOwl: "Allocco",
        camberwellBeauty: "Atalanta",
        peacockButterfly: "Occhio di pavone",
        silverWashedFritillary: "Argynnis paphia",
        purpleEmperor: "Apatura iris",
        largeTortoiseshell: "Nymphalis polychloros",
        redSquirrel: "Scoiattolo rosso",
        redSquirrelsAtopAnOak: "su una quercia",
        blackberries: "More",
        chanterelle: "Galletto",
        flyagaric: "Amanita muscaria",
        moss: "Muschio",
        parasolMushroom: "Mazze di tamburo",
        pennyBun: "Porcino",
        treeFerns: "Felci arboree",
        wildStrawberries: "Fragole selvatiche",
        commonToad: "Rospo comune",
        sharingACardSlot: "condividono lo slot",
        pondTurtle: "Testuggine palustre",
        treeFrog: "Raganella",
        fireSalamander: "Salamandra pezzata",
        fireflies: "Lucciole",
        woodAnt: "Formica rufa",
        hedgehog: "Riccio",
        mole: "Talpa",
        ...
        bechsteinsBat: "Pipistrello di Bechstein",
        brownLongEaredBat: "Orecchione bruno",
        greaterHorseshoeBat: "Rinolofo maggiore",
        fallowDeer: "Daino",
        redDeer: "Cervo nobile",
        ...
        squeaker: "Fringuello",
        deerAndCloven: "Cervidi e ungulati",
        wildBoar: "Cinghiale",
        beechMarten: "Faina",
        ...
        batOnTheOtherSide: "con pipistrello di fronte",
        europeanHare: "Lepre europea",
        lynx: "Lince",
        raccoon: "Procione",
        redFox: "Volpe",
        wolf: "Lupo",
...
// Alpine Erweiterung
        europeanLarch: "Larice europeo",
        stonePine: "Pino cembro",
        alpineMarmot: "Marmotta alpina",
        chamois: "Camoscio",
        capercaillie: "Gallo cedrone",
        mountainHare: "Lepre alpina",
        steinbock: "Stambecco",
        savisPipistrelle: "Pipistrello pigmeo",
        phoebusApollo: "Apollo",
        blackTrumpet: "Trombetta nera",
        edelweiss: "Stella alpina",
        blueberry: "Mirtillo",
        alpineNewt: "Tritone alpino",
        goldenEagle: "Aquila reale",
        beardedVulture: "Avvoltoio barbuto",
        gentian: "Genziana",
